...
from poprox_recommender.components.filters.image_selector_clip_selective import (
    SelectiveImageSelector,
)
...
def configure(builder: PipelineBuilder, num_slots: int, device: str):
    ...
    # Selective image personalization on top of the ranked articles (post-processing)
    # This will randomly choose to personalize either odd or even positioned articles (50% of total)
    builder.add_component(
        "selective_image_personalizer",
        SelectiveImageSelector,
    ...
    # Expose selective personalized results as the recommender output
    builder.alias("recommender", "selective_image_personalizer")
