...
class TestService(Protocol):
    ...
    def request(self, req: RecommendationRequestV3 | str, pipeline: str) -> RecommendationResponseV3:
        """
...
class InProcessTestService:
    ...
    def request(
        self, req: RecommendationRequestV3 | str, pipeline: str, compress: bool = False
        ...
        return RecommendationResponseV3.model_validate_json(res["body"])
...
class DockerTestService:
    ...
    def request(
        ...
        return RecommendationResponseV3.model_validate_json(res_data["body"])
...
class RequestGenerator:
    ...
    def get_request(self) -> RecommendationRequestV3:
        ...
        try:
            request = RecommendationRequestV3(
